...
void setup() {
  ...
  NPC_the_guy =                                      new NPC();
  Cat =                                              new Cat();
  object_fireanim =                                  new Fire();

  mug =                                              new Mug(580f, 400f, 100f, 100f);
  pot  =                                             new Pot(695f, 430f, 125f, 125f);
  coffee_Beans  =                                    new coffee_Beans(true, 1120f, 430f, 100f, 100f);
  rag =                                              new Rag(true, 205f, 260f, 150f, 150f);
  toaster =                                          new Toaster(140f, 423f, 150f, 150f);
  pan =                                              new Pan(280f, 363f, 150f, 150f);
